            ...
            <Card className="w-full">
              <CardContent className="relative p-6">
                ...
                <Button
                    variant="outline"
                    className={cn(
                      "flex items-center gap-2 px-4 py-2 text-gray-700 hover:text-gray-900 border-gray-300",
                      copied && "text-green-600 hover:text-green-700 border-green-500"
                    )}
